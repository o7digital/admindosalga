...
export function publicationVariants(detail, identity, proposal) {
  ...
  if (proposal.currency !== identity.currency || detail.platformProductPricesCurrency !== identity.currency) throw new Error('CJ and dashboard currencies do not match. Verify the source currency before publishing.');
