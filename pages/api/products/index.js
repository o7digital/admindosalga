...
const buildProduct = (payload) => {
  ...
  return {
    ...
    saleCurrency,
    sourcePrice: Number(payload.sourcePrice ?? payload.salePrice) || 0,
    sourceCurrency: payload.sourceCurrency || saleCurrency,
    sourceManagedByAdmin: Boolean(payload.sourceManagedByAdmin),
